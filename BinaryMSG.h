...
void ShowRtcm1074(U08* src, int len, bool convertOnly = false, CString* pStr = NULL);
void ShowRtcm1084(U08* src, int len, bool convertOnly = false, CString* pStr = NULL);
void ShowRtcm1094(U08* src, int len, bool convertOnly = false, CString* pStr = NULL);
void ShowRtcm1104(U08* src, int len, bool convertOnly = false, CString* pStr = NULL);
void ShowRtcm1114(U08* src, int len, bool convertOnly = false, CString* pStr = NULL);
void ShowRtcm1124(U08* src, int len, bool convertOnly = false, CString* pStr = NULL);
...
void ShowUbxNavStatus(U08* src, bool convertOnly = false, CString* pStr = NULL);
